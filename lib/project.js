...
(function() {
  ...
  this.BaseElement = (function(_super) {
    ...
    BaseElement.prototype.setInteractive = function(state) {
      ...
      _this = this;
      if (this.sprite) {
        this.sprite.setInteractive(state);
      }
      if (state) {
        if (!this.helper) {
          this.addHelper();
      ...
      if (this.game.inventory.isHandFree()) {
        ...
        if (this.scene.findElement('georgette').dead) {
          if (this.scene.onFire) {
            return this.game.textManager.setText("I cannot leave by foot, they will find me. Better take his car.");
          } else {
            return this.game.textManager.setText("I need to fix this mess.");
          }
        } else {
          return this.game.textManager.setText("I cannot leave him leave like that.");
        }
        ...
        return this.game.textManager.setText(false);
      } else {
