...
(function() {
  ...
  this.Wardrobe = (function(_super) {
    ...
    function Wardrobe() {
      return Wardrobe.__super__.constructor.apply(this, arguments);
    }

    Wardrobe.prototype.mouseClick = function() {
      Wardrobe.__super__.mouseClick.apply(this, arguments);
      this.game.textManager.setText("No time for that!");
...
(function() {
  ...
  this.TextManager = (function(_super) {
    ...
    function TextManager(game) {
      ...
      this.setY(Game.HEIGHT - this.background.getHeight() - 30);
      this.game.addChild(this);
