...
(function() {
  ...
  this.BaseElement = (function(_super) {
    ...
    BaseElement.prototype.noHelper = function() {
      if (this.helper) {
        this.helper.hide();
      }
      this.helper = null;
    ...
    BaseElement.prototype.withHitBox = function() {
      var sprite;
      sprite = new Sprite(GameAssets.getImage('abstract/debug.png'));
      this.setSprite(sprite);
      sprite.width = 20;
      sprite.height = 20;
      return sprite.alpha = Game.DEV_ENV ? 0.3 : 0;
    };
    ...
    BaseElement.prototype.setText = function(t, style) {
      this.textHolder = t;
      if (!style) {
        style = {
          font: "20px Arial",
...
(function() {
  ...
  this.InteractionsManager = (function() {
    ...
    InteractionsManager.prototype.useOn = function(itemClicked) {
      ...
      if (this.game.inventory.isHolding("umbrella")) {
...
(function() {
  ...
  this.Scene = (function(_super) {
    ...
    Scene.prototype.loadBackgrounds = function() {
      var background, bg, bgs, _i, _len, _this;
      ...
      for (_i = 0, _len = bgs.length; _i < _len; _i++) {
        bg = bgs[_i];
        background = new BaseElement(this.game).withSprite(bg);
        background.noHelper();
        background.mouseClick = function() {
          _this.game.textManager.next();
          return _this.game.inventory.use(null);
        };
...
(function() {
  ...
  this.Carpet = (function(_super) {
    ...
    function Carpet() {
      return Carpet.__super__.constructor.apply(this, arguments);
    }

    Carpet.prototype.mouseClick = function() {
      Carpet.__super__.mouseClick.apply(this, arguments);
      return this.game.camera.blink();
    };
...
(function() {
  ...
  this.Couch = (function(_super) {
    ...
    function Couch() {
      return Couch.__super__.constructor.apply(this, arguments);
    }

    Couch.prototype.mouseClick = function() {
      Couch.__super__.mouseClick.apply(this, arguments);
      return this.game.textManager.setText("Not the best moment to rest.");
    };
...
(function() {
  ...
  this.Door = (function(_super) {
    ...
    Door.prototype.mouseClick = function() {
      Door.__super__.mouseClick.apply(this, arguments);
      if (this.game.inventory.isHandFree()) {
        if (this.neighborVisited) {

        } else {
          return this.game.textManager.setText("I cannot leave him leave that.");
        }
      }
    };
...
(function() {
  ...
  this.EntranceDrawer = (function(_super) {
    ...
    function EntranceDrawer() {
      return EntranceDrawer.__super__.constructor.apply(this, arguments);
    }

    EntranceDrawer.prototype.mouseClick = function() {
      EntranceDrawer.__super__.mouseClick.apply(this, arguments);
      this.game.textManager.setText("Nothing.");
      return this.game.soundManager.playSound('apartment-drawer');
    };
...
(function() {
  ...
  this.Fridge = (function(_super) {
    ...
    Fridge.prototype.mouseClick = function() {
      Fridge.__super__.mouseClick.apply(this, arguments);
      return this.game.textManager.setText("I'm not hungry.");
    };
...
(function() {
  ...
  this.GeorgeCorpse = (function(_super) {
    ...
    function GeorgeCorpse() {
      return GeorgeCorpse.__super__.constructor.apply(this, arguments);
    }

    GeorgeCorpse.prototype.mouseClick = function() {
      if (this.game.inventory.isHolding('knife')) {
        this.game.textManager.setText("Well, I don't think it need more!");
        return;
      }
      if (this.game.inventory.isHandFree()) {
        this.game.textManager.setText("Fuck... What can I do with that?");
      }
...
(function() {
  ...
  this.Georgette = (function(_super) {
    ...
    function Georgette() {
      return Georgette.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  this.GoldenHand = (function(_super) {
    ...
    GoldenHand.prototype.mouseClick = function() {
      GoldenHand.__super__.mouseClick.apply(this, arguments);
      return this.game.textManager.setText("Nothing.");
    };
...
(function() {
  ...
  this.Knife = (function(_super) {
    ...
    function Knife() {
      return Knife.__super__.constructor.apply(this, arguments);
    }

    Knife.prototype.mouseClick = function() {
      var _this;
      _this = this;
      if (this.game.inventory.isHolding('george')) {
        this.game.textManager.setText("Well, even if I try really hard, it will not look like a suicide...");
        return;
      }
      if (this.game.inventory.isHandFree()) {
        this.game.textManager.setText(["Did I just grabbed a weapon used in a crime?", "Am I really THAT dumb?", "Yes I am!"]).onTextRead(function() {
...
(function() {
  ...
  this.Painting = (function(_super) {
    ...
    Painting.prototype.mouseClick = function() {
      Painting.__super__.mouseClick.apply(this, arguments);
      return this.game.textManager.setText("What a fine piece of art.");
    };
...
(function() {
  ...
  this.Phone = (function(_super) {
    ...
    Phone.prototype.mouseClick = function() {
      if (this.game.inventory.isHandFree()) {
        this.game.textManager.setText("Hello");
      }
...
(function() {
  ...
  this.PiggyBank = (function(_super) {
    ...
    PiggyBank.prototype.mouseClick = function() {
      PiggyBank.__super__.mouseClick.apply(this, arguments);
      return this.game.textManager.setText("A thrifty man.");
    };
...
(function() {
  ...
  this.Plate = (function(_super) {
    ...
    Plate.prototype.mouseClick = function() {
      Plate.__super__.mouseClick.apply(this, arguments);
      return this.game.textManager.setText("I'm not hungry.");
    };
...
(function() {
  ...
  this.Sink = (function(_super) {
    ...
    Sink.prototype.mouseClick = function() {
      Sink.__super__.mouseClick.apply(this, arguments);
      return this.game.textManager.setText("Not thirsty.");
    };
...
(function() {
  ...
  this.TrinketBowl = (function(_super) {
    ...
    function TrinketBowl() {
      return TrinketBowl.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  this.Wardrobe = (function(_super) {
    ...
    Wardrobe.prototype.mouseClick = function() {
      Wardrobe.__super__.mouseClick.apply(this, arguments);
      if (this.state === 'closed') {
        this.state = 'opened';
        this.game.textManager.setText("What's that shinny thing !?");
...
(function() {
  ...
  this.SceneApartment = (function(_super) {
    ...
    SceneApartment.prototype.leaving = function() {
      ...
      return this.game.soundManager.playSound('apartment-walking');
    };
...
(function() {
  ...
  this.SceneCar = (function(_super) {
    ...
    SceneCar.prototype.doEmergencyAction = function() {
      ...
      _this = this;
      this.crashed = true;
      this.game.soundManager.playSound('car-breaks');
...
(function() {
  ...
  this.TextManager = (function(_super) {
    ...
    function TextManager(game) {
      ...
      this.setX((Game.WIDTH - this.background.getWidth()) / 2);
      this.setY(Game.HEIGHT - this.background.getHeight() - 60);
      this.game.addChild(this);
    ...
    TextManager.prototype.addNextButton = function() {
      var _this;
      this.nextButton = new BaseElement(this.game);
      this.nextButton.withSprite('abstract/text_next.png');
      this.nextButton.noHelper();
      this.addChild(this.nextButton);
      this.nextButton.setX(this.background.getWidth() - this.nextButton.getWidth() - 20);
      this.nextButton.setY(this.background.getHeight() - 20);
      _this = this;
      return this.nextButton.setInteractive(true).mouseClick = function() {
        return _this.next();
      };
    };
