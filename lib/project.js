...
(function() {
  ...
  this.CarControl = (function(_super) {
    ...
    CarControl.prototype.mouseClick = function() {
      return CarControl.__super__.mouseClick.apply(this, arguments);
    };
...
(function() {
  ...
  this.Door = (function(_super) {
    ...
    Door.prototype.mouseClick = function() {
      ...
      this.goingOut = true;
      return this.game.sceneManager.change('transitionApartmentOut');
    };
...
(function() {
  ...
  this.GeorgeCorpse = (function(_super) {
    ...
    GeorgeCorpse.prototype.mouseClick = function() {
      GeorgeCorpse.__super__.mouseClick.apply(this, arguments);
      return this.game.textManager.setText("Fuck. FUCK. FUCK!");
    };
...
(function() {
  ...
  this.Phone = (function(_super) {
    ...
    Phone.prototype.mouseClick = function() {
      ...
      return this.game.textManager.setText("Hello");
    };
...
(function() {
  ...
  this.Radio = (function(_super) {
    ...
    Radio.prototype.mouseClick = function() {
      ...
      return this.scene.showEmergencyControls();
    };
...
(function() {
  ...
  this.TrinketBowl = (function(_super) {
    ...
    TrinketBowl.prototype.mouseClick = function() {
      TrinketBowl.__super__.mouseClick.apply(this, arguments);
      return this.game.textManager.setText("Nothing.");
    };
...
(function() {
  ...
  this.Umbrella = (function(_super) {
    ...
    Umbrella.prototype.mouseClick = function() {
      Umbrella.__super__.mouseClick.apply(this, arguments);
      return this.game.textManager.setText("It's not raining outside.");
    };
...
(function() {
  ...
  this.SceneCar = (function(_super) {
    ...
    function SceneCar() {
      ...
      this.game.soundManager.playMusic('music-car');
...
(function() {
  ...
  this.TextManager = (function(_super) {
    ...
    TextManager.prototype.updateText = function() {
      ...
      return this.textHolder.setText(text);
    };
