...
(function() {
  ...
  this.SceneElement = (function(_super) {
    ...
    SceneElement.prototype.placeText = function() {
      ...
      this.currentText.setY(this.hitbox.getY() - this.currentText.height);
      return this;
    };
...
(function() {
  ...
  this.GameAssets = (function() {
    ...
    function GameAssets(game) {
      ...
      this.startBackground = new PIXI.JsonLoader('/src/json/assets.json');
      this.startBackground.on('loaded', function(event) {
