...
(function() {
  ...
  this.SceneElement = (function(_super) {
    ...
    SceneElement.prototype.placeHelper = function() {
      ...
      this.helper.setX(this.hitbox.getX() + (this.hitbox.width / 2 - this.helper.width / 2));
      this.helper.setY(this.hitbox.getY() - this.helper.height / 2);
      return this;
    };
    ...
    SceneElement.prototype.placeText = function() {
      ...
      this.currentText.setX(this.hitbox.getX() + (this.hitbox.width / 2 - this.currentText.width / 2));
      this.currentText.setY(this.hitbox.getY() - this.currentText.height * 1.5);
      return this;
    };
...
(function() {
  ...
  this.Carpet = (function(_super) {
    ...
    Carpet.prototype.mouseClick = function() {
      if (this.game.inventory.isHandFree()) {
        if (this.occupied) {
          this.game.textManager.setText("That a pretty big burrito.");
          return;
        } else {
...
(function() {
  ...
  this.Flame = (function(_super) {
    ...
    function Flame() {
      ...
      this.state1 = new BaseElement(this.game).withSprite('elements/apartment-flame01.png');
      this.state2 = new BaseElement(this.game).withSprite('elements/apartment-flame02.png');
...
(function() {
  ...
  this.Georgette = (function(_super) {
    ...
    function Georgette() {
      ...
      this.stateCrazy1 = new BaseElement(this.game).withSprite('elements/apartment-georgette-crazy-1.png');
      this.stateCrazy2 = new BaseElement(this.game).withSprite('elements/apartment-georgette-crazy-2.png');
      ...
      this.addChild(this.stateCrazy1.hide());
      this.addChild(this.stateCrazy2.hide());
    ...
    Georgette.prototype.enter = function() {
      ...
      _this = this;
      this.show();
      return this.crazyTimeout = setTimeout((function() {
        return _this.goCrazy();
      }), 1);
    };
    ...
    Georgette.prototype.tick = function() {
      ...
      if (this.crazy && !this.dead) {
        ...
        this.stateCrazy1.show();
        if (this.game.life % 10 === 0) {
          this.stateCrazy1.toggle();
          return this.stateCrazy2.toggle();
        }
      }
    };
    ...
    Georgette.prototype.die = function() {
      ...
      this.dead = true;
      this.goMiddle();
      this.addY(180).addX(50);
      this.stateNormal.hide();
      this.stateCrazy1.hide();
      this.stateCrazy2.hide();
      ...
      this.hitbox.setX(0).setY(-30).setWidth(240).setHeight(110);
...
(function() {
  ...
  this.GloveBox = (function(_super) {
    ...
    GloveBox.prototype.mouseClick = function() {
      if (this.game.inventory.isHandFree()) {
        this.game.textManager.setText("Better focus on the road.");
        return;
      }
...
(function() {
  ...
  this.Wardrobe = (function(_super) {
    ...
    Wardrobe.prototype.open = function() {
      ...
      this.openedSprite.show();
      this.hitbox.setX(0).setY(-150).setWidth(150).setHeight(300);
...
(function() {
  ...
  this.Game = (function() {
    ...
    Game.prototype.start = function() {
      ...
      this.soundManager = new GameSounds(this);
      ...
      return this.addChild(this.startBackground);
    };
...
(function() {
  ...
  this.SceneApartment = (function(_super) {
    ...
    SceneApartment.prototype.lightCarpet = function() {
      var element, _i, _len, _ref;
      this.addChild(new Flame(this.game).setScale(0.5).setX(700).setY(330));
      this.addChild(new Flame(this.game).setScale(0.2).setX(900).setY(350));
      _ref = this.children;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        element = _ref[_i];
        element.zIndex = 3;
    ...
    SceneApartment.prototype.lightCouch = function() {
      var element, _i, _len, _ref;
      this.addChild(new Flame(this.game).setScale(0.5).setX(600).setY(550));
      this.addChild(new Flame(this.game).setScale(1).setX(600).setY(550));
      this.addChild(new Flame(this.game).setScale(0.2).setX(530).setY(420));
      this.addChild(new Flame(this.game).setScale(0.3).setX(470).setY(510));
      _ref = this.children;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        element = _ref[_i];
        element.zIndex = 3;
      ...
      if (this.transitioningTo) {
        ...
        if (this.scene && this.scene.alpha > 0) {
          ...
          if (this.scene.alpha < 0) {
            this.scene.alpha = 0;
            this.scene.hide().setInteractive(false);
            this.scene.setX(Game.WIDTH).setY(Game.HEIGHT);
