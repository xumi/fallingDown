...
(function() {
  ...
  this.SceneElement = (function(_super) {
    ...
    SceneElement.prototype.withHitBox = function() {
      var sprite;
    ...
    SceneElement.prototype.placeText = function() {
      this.currentText.setX(this.getWidth() / 2 - this.currentText.width / 2);
    ...
    SceneElement.prototype.getWidth = function() {
      if (this.sprite) {
        return this.sprite.width;
      } else {
        return this.width;
    ...
    SceneElement.prototype.getHeight = function() {
      if (this.sprite) {
        return this.sprite.height;
      } else {
        return this.height;
...
(function() {
  ...
  this.PiggyBank = (function(_super) {
    ...
    function PiggyBank() {
      PiggyBank.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  this.Wardrobe = (function(_super) {
    ...
    Wardrobe.prototype.open = function() {
      ...
      this.sprite.setX(0).setY(-150).setWidth(200).setHeight(300);
...
(function() {
  ...
  this.TextManager = (function(_super) {
    ...
    TextManager.prototype.mouseClick = function() {
      ...
      this.game.textManager.next();
      return this.game.inventory.use(null);
    };
